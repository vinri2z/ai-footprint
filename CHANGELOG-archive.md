# Changelog archive (pre-v1.1.0)

This is the curated, hand-written changelog kept before claude-footprint adopted
[semversioner](https://github.com/raulgomis/semversioner). New releases are recorded in
[CHANGELOG.md](CHANGELOG.md), generated from `.semversioner/` changesets.
...
- **feat:** statusline order CO2 . water . cost; water sub-1L in mL
- **feat:** Makefile semver tooling (add-change, release)
